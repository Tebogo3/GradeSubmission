...
public class GradeServiceImpl implements GradeService {
    ...
    public Grade saveGrade(Grade grade, Long studentId, Long courseId) {
        Student student =  StudentServiceImpl.unwrapStudent(studentRepository.findById(studentId), studentId);//for us to call own custom exception error message
        Course course = CourseServiceImpl.unwrapCourse(courseRepository.findById(courseId), courseId);//for us to call own custom exception error message
